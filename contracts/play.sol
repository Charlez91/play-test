...
contract Play is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    uint public constant maxPlayPurchcase = 5;

    uint256 public MAX_PLAY = 1000;

    bool public saleIsActive = false;

    event BalanceWithdrawn( address payable Owner, uint amount);
    event saleStateFlipped(bool saleIsActive);
    

    constructor() ERC721("PLAY", "PNFT") {}
